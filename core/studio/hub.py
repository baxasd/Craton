    ...
    with center_col:
        ...
        with r1_c1:
            with st.container(border=True):
                ...
                if st.button(
                    "Launch Module", key="btn_prep", type="primary", width="stretch"
                ):
        ...
        with r1_c2:
            with st.container(border=True):
                ...
                if st.button(
                    "Launch Module", key="btn_gait", type="primary", width="stretch"
                ):
        ...
        with r2_c1:
            with st.container(border=True):
                ...
                if st.button(
                    "Launch Module", key="btn_viz", type="primary", width="stretch"
                ):
        ...
        with r2_c2:
            with st.container(border=True):
                ...
                if st.button(
                    "Launch Module", key="btn_radar", type="primary", width="stretch"
                ):
